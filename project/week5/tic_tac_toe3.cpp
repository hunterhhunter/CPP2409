...
int main() {
    ...
    int turn = 1; // 턴 개념 정의를 위한 변수 선언 (false시 1번 플레이어)
    ...
    while (true) {
        ...
        if (turn%3 == 1) {
            ...
            cout << "세번째 플레이어(V)의 차례입니다. -> ";
            currentPlayerStone = 'V';
        }
        ...
        for (int i=0; i<SIZEOFBOARD;i++) {
            ...
            if (check == 3) {
                if (currentPlayerStone == 'X') {
                    ...
                    return 0;
                } else if (currentPlayerStone == 'O') { 
                    cout << "두번째 플레이어(O)가 " << i+1 << "번째 가로 선에 모두 돌을 놓았습니다. 승리했습니다.";
                    return 0;
                } else {
                    cout << "세번째 플레이어(V)가 " << i+1 << "번째 가로 선에 모두 돌을 놓았습니다. 승리했습니다.";
                    return 0;
                }
            }
        }
        ...
        for (int i=0; i<SIZEOFBOARD; i++) {
            ...
            if (check == 3) {
                if (currentPlayerStone == 'X') {
                    ...
                    cout << "세번째 플레이어(V)가 " << i+1 << "번째 세로 선에 모두 돌을 놓았습니다. 승리했습니다.";
                    return 0;
                }
            }
        }
        ...
        if (check == 3) {
            if (currentPlayerStone == 'X') {
                ...
                cout << "세번째 플레이어(V)가 좌상단 -> 우하단 선에 모두 돌을 놓았습니다. 승리했습니다.";
                return 0;
            }
        }
        if (check2 == 3) {
            if (currentPlayerStone == 'X') {
                ...
                cout << "세번째 플레이어(V)가 우상단 -> 좌하단 선에 모두 돌을 놓았습니다. 승리했습니다.";
                return 0;
            }
        }
        // 모든 칸이 찼는지 확인
